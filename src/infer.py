...
if __name__ == '__main__':
    ...
    run_name = "debug_segmentation_withh5"
    ...
    #
    infer_segmentation(location=location, relative_model_path="/testing_new_segmentation/weights/1600.pt", run_name=run_name, slice_thickness="large", use_nifti=False, nifti_location='/data/centered', make_hdf5=True, do_skull_strip=True, hdf5_location=f'{location}/data/centered.hdf5')
